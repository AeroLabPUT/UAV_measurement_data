...
Each line contains (rangeStop - rangeStart + 1)  values for every of 12 sensor axis, i.e. if rangeStop = 39 and rangeStart = 20, there are 240 values in every line, because 28*4*3 = 240
