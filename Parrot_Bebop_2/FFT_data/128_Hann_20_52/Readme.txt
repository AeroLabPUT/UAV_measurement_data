...
Each line contains (rangeStop - rangeStart + 1)  values for every of 12 sensor axis, i.e. if rangeStop = 52 and rangeStart = 20, there are 396 values in every line, because 33*4*3 = 396
